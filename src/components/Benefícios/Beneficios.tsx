...
export default function Beneficios(){
    ...
    return(
        <div className="bg-verdeEscuro min-h-[80vh] relative flex flex-col px-[50px] py-[100px] mb-[400px]">
            ...
            <div className="containerBtBeneficios bg-white border-2 border-solid border-white px-12 py-4 self-center text-verdeEscuro text-xl font-bold relative group cursor-pointer">
                Explore Nossos Benefícios
                <div className="btBeneficiosCima absolute inset-0 border-2 border-solid border-verdeClaro bg-verdeEscuro text-verdeClaro flex justify-center items-center text-xl font-bold [clip-path:polygon(0%_0%,0%_0%,0%_100%,0%_100%)] group-hover:[clip-path:polygon(0%_0%,100%_0%,100%_100%,0%_100%)] transition-all duration-700 ease-in-out ">
                    Explore Nossos Benefícios
                </div>
            </div>
        </div>
