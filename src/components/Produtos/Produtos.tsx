...
export default function Produtos(){
  ...
  useGSAP(() => {
    ...
    return (
        <div className="containerProdutos bg-verdeClaro px-[50px] py-[100px]">
            <div className="flex flex-col ">
                <div className="text-verdeEscuro text-6xl lg:mt-0 mt-12 uppercase flex overflow-hidden">
                    {
                ...
                <div  className="lg:linha1Prod flex flex-col lg:mt-20 mt-12 lg:gap-32 gap-8">
                    ...
                    <div className="lg:linha2Prod flex lg:flex-row flex-col lg:gap-20 gap-8">
                    ...
                    <div className="lg:linha3Prod flex lg:flex-row flex-col lg:gap-20 gap-8">
